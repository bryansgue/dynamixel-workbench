...
class DynamixelController
{
 private:
  ...
  sensor_msgs::Joy arm_state_msg_;
 ...
 public:
  ...
  void vel_control_callback(const sensor_msgs::Joy::ConstPtr& msg);
  //void commandVelocityCallback(const sensor_msgs::Joy::ConstPtr &msg)
